                ...
                <div class="row">
                    <div class="col-4">
                       <div class="card">
                            ...
                            <img src="../assets/images/users/5.jpg" height="280px" width="300px">
                            </div>
                            </div>
                            </div>        
                                <div class="col-8">
                            <div class="card">
                            <div class="card-blockd">
                            <form class="form-horizontal",>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="email" class="form-control" id="inputcontact" placeholder="contact no.">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label for="inputPassword4" class="col-sm-3 text-right control-label col-form-label">Query</label>
                                    <div class="col-sm-8">
                                        <input type="Query" class="form-control" id="inputquery" placeholder="Query">
                                    </div>
                                </div>
                                <div class="form-group row">
                                            ...
                                            <div class="modal-body">
                                                <form>
                                                    <div class="form-group">
                                                        <p>Your message has been recorded.<br>
                                                        Thank You!</p>
                                                    </div>
                                                </form>
                                            </div>
