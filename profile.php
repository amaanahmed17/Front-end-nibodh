                        ...
                        <div class="card">
                            <div class="card-block">
                                <center class="m-t-30"> <img src="../assets/images/users/5.jpg" class="img-circle" width="150" />
                                    <h4 class="card-title m-t-10">Amaan Ahmed</h4>
                            ...
                            <div class="card-block"> <small class="text-muted">Email address </small>
                                <h6>amaanahmed615@gmail.com</h6> <small class="text-muted p-t-30 db">Phone</small>
                                ...
                                <br/>
                                <a href="https://github.com/" class="btn btn-circle btn-secondary"><i class="fa fa-github"></i></a>
                                    ...
                                    <div class="card-block">
                                        <div class="row">
                                            <div class="col-md-3 col-xs-6 b-r"> <strong>Full Name</strong>
                                                <br>
                                                <p class="text-muted">Amaan Ahmed</p>
                                            </div>
                                            ...
                                            <div class="col-md-3 col-xs-6 b-r"> <strong>Email</strong>
                                                <br>
                                                <p class="text-muted">amaan@admin.com</p>
                                            </div>
                                        ...
                                        <h5 class="m-t-30">Photoshop <span class="pull-right">95%</span></h5>
                                        <div class="progress">
                                            <div class="progress-bar bg-warning" role="progressbar" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100" style="width:95%; height:6px;"> <span class="sr-only">50% Complete</span> </div>
                                        </div>
                                    </div>
                                </div>
